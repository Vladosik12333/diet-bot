...
export const MESSAGE_ON_START =
    'Привіт! Я Дієтичний Бот та допомогаю при пострункішані тим що допомагаю підтримувати звіт харчування.\nДобав мене в групу щоб побачити подальші інструкції.';
