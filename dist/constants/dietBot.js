...
export const MESSAGE_AFTER_CHANGING_PUNISHMENT = (username, activity) => `@${username} , ваша фізична активність за порушення правил встановлена на ${activity}`;
export const NEEDED_STATUS = 'administrator';
export const MESSAGE_AFTER_GETTING_NEEDED_STATUS = 'Я почав працювати.';
export const MESSAGE_AFTER_GETTING_BAD_STATUS = 'Ви забрали в мене потрібні права, тому я перестав працювати.\nP.S. Мені потрібно видати права Адміністратор - право прикріпляти повідомлення.';
export const CANNOT_FIND_POLL = 'Не вдалось знайти потрібного опиту.';
export const MESSAGE_ON_WRAPPER_ERROR = (message, error) => `Трапилась помилка - ${message}\nОб'єкт помилки:\n${error}`;
export const NOT_ENOUGH_RIGHTS = 'Я не маю потрібних прав для роботи. Мені потрібно видати права Адміністратор - право прикріпляти повідомлення.';
export const UNKNWON_ERROR = 'Невідома помилка';
export const CREATED_CHAT_BY_ERROR = 'Трапилась помилка і були перестворені деякі дані. Потрібно видати права Адміністратор - право прикріпляти повідомлення та ввести команду повторно.';
