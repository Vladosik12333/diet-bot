...
function startBot() {
    ...
    app.listen(config_1.port, function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bot.api.setWebhook("https://".concat(config_1.domain, "/").concat(config_1.token))];
                case 1:
                    _a.sent();
